...
#ifndef OCALL_GET_BUCKET_DEFINED__
#define OCALL_GET_BUCKET_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_bucket, (int data_structure, size_t index, unsigned char* bucket, size_t bucket_size));
#endif
#ifndef OCALL_PUT_BUCKET_DEFINED__
#define OCALL_PUT_BUCKET_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_put_bucket, (int data_structure, size_t index, const unsigned char* bucket, size_t bucket_size));
#endif
...
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_retrieve_M_c, (void* _u_prime, size_t _u_prime_size, void* _v_prime, size_t _v_prime_size, size_t token_size, int* v_size, size_t int_len));
#endif
